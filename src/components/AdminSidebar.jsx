...
import { LayoutDashboard, Music, Users, CreditCard, ShoppingCart, Library, Settings, LogOut, Bell, User as UserIcon, X, Megaphone, Terminal, Mail } from 'lucide-react';
...
function AdminSidebar({ isOpen, closeSidebar }) {
  ...
  const menuItems = [
    ...
    { path: '/devvorx/admin-1/payment-attempts', icon: <ShoppingCart size={20} />, label: 'Tentatives d\'Achat' },
    { path: '/devvorx/admin-1/campaigns', icon: <Mail size={20} />, label: 'Campagnes Emails' },
